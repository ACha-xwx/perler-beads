...
export async function downloadImage({
  ...
  const processDownload = () => {
    ...
    ctx.fillText(APP_NAME, titleStartX, mainTitleY);
    ...
    ctx.textAlign = 'right';
    ctx.textBaseline = 'middle';
    ctx.fillText(`${N} x ${M} · ${selectedColorSystem}`, downloadWidth - titleBarHeight * 0.25, titleBarHeight / 2);
